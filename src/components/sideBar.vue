...
.list-item {
  @apply flex flex-col items-center justify-center gap-2 px-4 py-2 text-sm text-gray-700;
  &:hover {
    @apply text-primary ring-4 ring-primary rounded-md px-4 py-2 duration-700 transition-all ease-in-out;
