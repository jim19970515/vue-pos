...
<template>
	<div class="h-screen w-screen overflow-hidden flex flex-col" :class="dark?'dark':''">
		<header class="flex items-center justify-between w-full overflow-hidden bg-primary dark:bg-gray-900 sm:px-6 text-xl sm:text-3xl text-white py-2 px-4 font-bold">
			<nav class="flex items-center gap-2 sm:gap-4">
				<img src="/src/assets/posLogo.png" class="object-cover h-8 sm:h-20" alt=""/>
				<h1>心心Pos</h1>
			</nav>
			<div class="flex items-center gap-6">
				<h2 class="text-lg sm:text-2xl text-white font-medium text-center sm:block hidden">{{newDate}}</h2>
		...
		<footer class="w-full bg-primary self-end sm:h-16 h-12 flex flex-end items-center justify-center text-white px-4 dark:bg-gray-800">
